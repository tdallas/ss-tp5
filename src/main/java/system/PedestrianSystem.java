...
//    public static final double MAX_VELOCITY = 0.95; // m/s
    ...
    public static final double WIDTH = RADIUS * 2 * Math.PI;  // m
    public static final double HEIGHT = 5 * (MAX_RADIUS + MIN_RADIUS);  // m
    ...
    public static void runSimulation() {
        ...
        PedestrianSystemGenerator pedestrianSystemGenerator = new PedestrianSystemGenerator(PARTICLES_QUANTITY, random, WIDTH, HEIGHT, MAX_RADIUS, MIN_RADIUS, MAX_VELOCITY, BETA);
        ...
        TimeStepSimulator timeStepSimulator = new TimeStepSimulator(TIME_DELTA, SAVE_TIME_DELTA, timeCutCondition, pedestrianFileGenerator, pedestrianSystemGenerator.getParticles(), WIDTH, HEIGHT, MIN_RADIUS, MAX_RADIUS, MAX_VELOCITY, BETA, TAU);
